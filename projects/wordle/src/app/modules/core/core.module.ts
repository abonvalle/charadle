...
const MODULES: any = [LayoutComponent, TopbarComponent, SettingsDialogComponent, HelpDialogComponent];
...
@NgModule({
  ...
  imports: [SharedModule, MatMenuModule, MatDialogModule, MatSlideToggleModule, MatInputModule, MatButtonModule],
  exports: []
})
