...
describe('AssetsService', () => {
  ...
  beforeEach(() => {
    service = new AssetsService(new EnvironmentService(new UtilsService()));
  });
  ...
  it('themes should be an array of theme', () => {
    const isArray = Array.isArray(service.themes$.value);
    const isArrayOfTheme = service.themes$.value.every(
